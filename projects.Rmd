...
```{r, eval = FALSE, label = "dayOfWeekSeasons", echo = FALSE, warning=FALSE, message=FALSE}
...
```{r, eval=FALSE, message = FALSE, warnings = FALSE, echo = FALSE}
...
##Member Demographics
Riders tend to be aged towards the upper 20s
```{r, eval=FALSE, message = FALSE, warnings = FALSE, echo = FALSE}
